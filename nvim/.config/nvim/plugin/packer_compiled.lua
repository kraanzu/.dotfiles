...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'vim-anyfold', 'nvim-treesitter', 'vim-highlightedyank', 'vim-surround', 'tcomment_vim'}, { event = "BufRead *" }, _G.packer_plugins)]]
