...
_G.packer_plugins = {
  ...
  ["vim-markdown"] = {
    loaded = true,
    path = "/home/esdeath/.local/share/nvim/site/pack/packer/start/vim-markdown",
...
vim.cmd [[au BufNewFile * ++once lua require("packer.load")({'nvim-treesitter', 'vim-anyfold'}, { event = "BufNewFile *" }, _G.packer_plugins)]]
vim.cmd [[au BufRead * ++once lua require("packer.load")({'tcomment_vim', 'nvim-treesitter', 'vim-anyfold', 'vim-highlightedyank'}, { event = "BufRead *" }, _G.packer_plugins)]]
