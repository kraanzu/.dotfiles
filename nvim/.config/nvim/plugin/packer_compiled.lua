...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'vim-anyfold', 'nvim-treesitter', 'vim-surround', 'vim-highlightedyank', 'tcomment_vim'}, { event = "BufRead *" }, _G.packer_plugins)]]
